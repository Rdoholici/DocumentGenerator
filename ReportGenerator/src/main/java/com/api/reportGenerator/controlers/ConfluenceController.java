...
public class ConfluenceController {
    ...
    ConfluenceReleaseInfo getConfluenceInfo(@PathVariable String narID) {

        ConfluenceReleaseInfo test=new ConfluenceReleaseInfo("releaseDate", "region", "releaseNumber", "appName");
